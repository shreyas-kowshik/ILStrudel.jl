...
for (i,dataset) in enumerate(datasets):
    ...
    command = "tmux new-session -d -s {} 'julia1 example_train.jl --name {} --run_name {} --pseudocount 1.0 --maxiter 150 --pmi_thresh 0.03 --population_size 300 --num_mine_samples 5 --mine_iterations 3 --num_mi_bags 50 --seed 42'".format(sess, dataset, run_name)
