...
for (i,dataset) in enumerate(datasets):
    ...
    run_name = "bag3_tem_42"
    command = "tmux new-session -d -s {} 'julia1 example_train.jl --name {} --run_name {} --pseudocount 1e-9 --maxiter 30 --pmi_thresh 0.03 --population_size 300 --num_mine_samples 7 --mine_iterations 3 --num_mi_bags 20 --seed 42'".format(sess, dataset, run_name)
